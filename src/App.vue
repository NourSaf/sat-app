<template>
  <div>
    ...
    <div class="section">
      <h3>GREAM</h3>
      <GeminiResponse :response="responses"/>
    </div>
...
export default {
  ...
  coordinates_sat: {
    ...
    handler(newCoords) {
        ...
        this.prompt = `Generate the satellites dream based of what the satellite is seeing from lattitude ${newCoords[0]}, longitude ${newCoords[1]} and altitude ${newCoords[2]}. Generate only the dream as a poem.`;
        this.sendToGemini();
      }
